<script setup>
    ...
    const submit = () => {
        form.put(route("admin.job-vacancy.update", form.id), {
            onSuccess: () => {
                $q.notify({
                    type: 'positive',
    ...
    function destroy() {
        $q.dialog({
            ...
            Inertia.delete(route('admin.job-vacancy.destroy', form.id), {
                onSuccess: () => {
                    $q.notify({
                        type: 'positive',
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Editar vaga </div>
                ...
                >
                    ...
                    <q-breadcrumbs-el label="Editar vaga" class="text-primary" />
                </q-breadcrumbs>
            </div>
