    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-pb-xl">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Quizz </div>
            ...
            <q-card-section class="q-py-none">
                ...
                >
                    ...
                    <template v-slot:body-cell-content_name="props">
                      ...
                      <template v-slot:body-cell-answer_file="props">
                        <q-td :props="props">
                            <a
                                v-if="props.row.answer_file"
                                :href="props.row.answer_file"
                                :download="`Gabarito-${props.row.name}`"
