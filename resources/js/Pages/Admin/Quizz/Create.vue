<script setup>
    ...
    const submit = () => {
        form
            .post(route("admin.quizz.store"), {
                onSuccess: () => {
                    $q.notify({
                        type: 'positive',
                        message: 'Quizz cadastrado com sucesso',
                        position: 'top',
                    })
                },
            })
...
<template>
    <AuthenticatedLayout>
        <Head title="Quizz | Novo" />

        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Novo quizz </div>
                ...
                >
                    ...
                    <q-breadcrumbs-el label="Novo quizz" class="text-primary" />
                </q-breadcrumbs>
            </div>
        </div>
