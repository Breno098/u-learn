<script setup>
    ...
    const submit = () => {
        form.post(route("admin.group.store"), {
            onSuccess: () => {
                $q.notify({
                    type: 'positive',
    ...
    const goBack = () => useForm().get(route('admin.group.index'))
</script>
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Novo grupo de alunos </div>
                ...
                >
                    ...
                    <q-breadcrumbs-el label="Novo grupo de alunos" class="text-primary" />
                </q-breadcrumbs>
            </div>
        </div>
