<script setup>
    ...
    const submit = () => {
        requestData.get(route('admin.commercial.index'), {
            preserveState: true,
            preserveScroll: true,
    ...
    const selectedMonthSubmit = () => {
        useForm({ month: month.value }).get(route('admin.commercial.index'), {
            preserveState: true,
            preserveScroll: true,
        });
    }

    const clearFilters = () => useForm().get(route('admin.commercial.index'))

</script>

<template>
    <Head title="Comercial"/>
        ...
        <div class="row q-pb-sm">
            <div class="column col-12 col-md-6 justify-center">
                ...
                >
                    ...
                    <q-breadcrumbs-el label="Comercial" class="text-primary" />
                </q-breadcrumbs>
            </div>
        </div>
