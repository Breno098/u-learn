 <script setup>
    ...
    const form = useForm({
        ...
        course_id: props.meeting.course_id,
    ...
    const submit = () => {
        form
            ...
            .post(route("admin.meeting.update", form.id), {
                onSuccess: (page) => {
                    $q.notify({
                        type: 'positive',
                    ...
                    form.materials = props.meeting.materials;
                },
            })
    };
    ...
    const destroy = () => {
        $q.dialog({
            ...
            useForm().delete(route('admin.meeting.destroy', form.id), {
                onSuccess: () => {
                    $q.notify({
                        type: 'positive',
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Editar encontro </div>
                ...
                >
                    ...
                    <q-breadcrumbs-el label="Editar encontro" class="text-primary" />
                </q-breadcrumbs>
            </div>
