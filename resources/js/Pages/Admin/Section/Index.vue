    ...
    const destroySelected = () => {
        $q.dialog({
            ...
            componentProps: {
                ...
                message: 'Ao excluir seções selecionadas, elas serão desvinculadas dos contéudos. Tem certeza que deseja excluir seções selecionadas?',
            },
        }).onOk(() => {
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-pb-xl">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Seções </div>
        ...
        <q-banner
            inline-actions
            class="text-white bg-negative q-mb-lg adm-br-16"
