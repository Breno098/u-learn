    ...
    const submit = () => {
        form.post(route("admin.item.store"), {
            onSuccess: () => {
                $q.notify({
                    type: 'positive',
                    message: 'Brinde cadastrado com sucesso',
                    position: 'top',
                })
            },
        })
...
<template>
    <AuthenticatedLayout>
        <Head title="Brinde | Adicionar" />

        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Adicionar brinde </div>
                ...
                >
                    ...
                    <q-breadcrumbs-el label="Adicionar brinde" class="text-primary" />
                </q-breadcrumbs>
            </div>
        </div>
