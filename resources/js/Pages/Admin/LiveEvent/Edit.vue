<script setup>
    ...
    const filterResponsible = (val, update, abort) => {
        update(() => ptionsResponsible.value = props.responsible.filter(s => s.name.toLowerCase().indexOf(val.toLowerCase()) > -1))
    }
    ...
    <AuthenticatedLayout>
        ...
        <div class="row q-mb-lg">
            <div class="column col-12 col-md-6 justify-center">
                <div class="adm-fs-28 adm-fw-700 adm-lh-32 text-grey-8"> Editar evento ao vivo </div>
